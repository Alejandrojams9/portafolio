...
<!-- Mirrored from baha.malyarchuk.space/index-image.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Aug 2019 01:02:02 GMT -->
                        ...
                        <div id="contact">
                            ...
                            <nav class="header-main" data-simplebar>
                                ...
                                <ul>
                                    ...
                                    <li data-tooltip="Pruebas" data-position="bottom">
                            ...
                            <div class="pt-home" style="background-image: url('img/home-bg.jpg')">
                                <section>
                                    ...
                                    <!-- Banner -->
                                    <div class="banner">
                                        <h1>Alejandro Meneses Sanchez</h1>
								...
								<b>Motivated to learn</b>
                                    ...
                                    <div class="lang">
                                        <ul>
                                            <li><a href="#" class="active">eng & Es</a></li>
                                    ...
                                    <div class="social">
                                        <ul>
                                            <li><a href="https://www.facebook.com/jorgealejandro.menesessanchez"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="https://www.facebook.com/jorgealejandro.menesessanchez"><i class="fab fa-twitter"></i></a></li>
                                            ...
                                            <div class="info box">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-sm-8">
                                                        <h4>Alex Smith</h4>
                                                        <div class="loc">
                                                            <i class="fas fa-map-marked-alt"></i> Mexico, Tlaxcala Tlaxcala
                                                        </div>
                                                        <p>¡Hola! Soy Alejandro Meneses, Diseñador y Desarrollador Digital autodidacta y licenciado en Ingeniería en Tecnologías de la Información. Comencé en la escuela secundaria arreglando software y hardware
                                                            de teléfonos celulares, me convertiré en un estudiante de cualquier tema de aprendizaje. Ahora estoy en pasando del nivel junior al master, trabajando en el conocimiento de las bases de datos
                                                            y disfrutando de la vida para tener un futuro mejor.


                                                        </p>
                                                        <p>Tengo un par de pasatiempos, pero me gusta programar y usar herramientas de hacking ético en Linux. Ya he pasado por varios lenguajes de programación , así como experiencia en bases de datos. Me
                                                            gusta comer y salir de fiesta.
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3 col-sm-12 pt-50">
                                                        <a href="https://drive.google.com/file/d/1nE5GHqQFTirsClgYg3s_ENDza2hrRnfZ/view" target="_blank" class="btn-st">Download CV</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mt-100">
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="service box mb-40">
                                                ...
                                                <h4>Web Design</h4>
                                                <p>Creacion de diseño por medio de herramientas establecidas para dicha area.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="service box mb-40">
                                                ...
                                                <p>Desarrollo en plataformas web mediante los lenguajes de html,css,js y Base de Dastos.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="service box mb-40">
                                                ...
                                                <p>Trabajando la resposive para distintas plataformas digitales.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="service box mb-40">
                                                ...
                                                <h4>quick Support</h4>
                                                <p>Integrando soporte a usuario.</p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="owl-carousel owl-theme">
                                            ...
                                            <div class="testimonial-item">
                                                <div class="media">
                                                    ...
                                                    <div class="content">
                                                        <h4>Ingeniero Roberto Ramirez</h4>
                                                ...
                                                <div class="comment pt-30">
                                                    <p>
                                                        Trabajador independiente de microempresas contratado para corrección y implementación de codigo.
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="testimonial-item">
                                                ...
                                                <div class="comment pt-30">
                                                    <p>
                                                        Administrador de el ITJ proveniente del estado de tlaxcala gerente de area tecnologica.
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="testimonial-item">
                                                ...
                                                <div class="comment pt-30">
                                                    <p>
                                                        Gerente de la empresa TECH IE donde se realiza la elaboracion de piezas industriales.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <section class="container">
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            ...
                                            <div class="experience box">
                                                ...
                                                <div class="item">
                                                    <div class="main">
                                                        <h4>Experiencia </h4>
                                                        <p><i class="far fa-calendar-alt"></i>2015 - 2017 | Telecelulares</p>
                                                    </div>
                                                    <p>Durante la instancia de este micro negocio se preparo para la relacion de software y Hardware de dispositivos android.
                                                    </p>
                                                </div>
                                                ...
                                                <div class="item">
                                                    <div class="main">
                                                        <h4>ITJ Tlaxcala,Tlaxcala</h4>
                                                        <p><i class="far fa-calendar-alt"></i>2014 - 2015 | Gobierno</p>
                                                    </div>
                                                    <p>Recepción de mantenimiento de equipo tecnológico, el correo, la distribución del material para los diferentes centros del ITJ.
                                                        <br> - Organización de los materiales que ofrece el gobierno adhiriéndome a las políticas y a la misión de ITJ.
                                                    </p>
                                                </div>
                                                ...
                                                <div class="item">
                                                    <div class="main">
                                                        <h4>TECH IE</h4>
                                                        <p><i class="far fa-calendar-alt"></i>2015 - 2019 | Сompany TECH IE</p>
                                                    </div>
                                                    <p>Persona de confianza para analizar e interpretar los datos, y manejar documentación. Conocida como la "persona de administración" para todos los departamentos, incluyendo control de calidad, contabilidad,
                                                        gestión, mediante tecnologías de aplicaciones de office y base de datos.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            ...
                                            <div class="experience box">
                                                ...
                                                <div class="item">
                                                    <div class="main">
                                                        <h4>CECyTE 06</h4>
                                                        <p><i class="far fa-calendar-alt"></i>septiembre 2016 – junio 2018 | Tepeyanco</p>
                                                    </div>
                                                    <p>Título de Bachillerato
                                                        <br> Título en Soporte y Mantenimiento de Equipo de Cómputo.
                                                    </p>
                                                </div>
                                                ...
                                                <div class="item">
                                                    <div class="main">
                                                        <h4>Universidad Politécnica de Tlaxcala</h4>
                                                        <p><i class="far fa-calendar-alt"></i>enero 2019 – Presente | Tepeyanco,</p>
                                                    </div>
                                                    <p>Universidad Politécnica de Tlaxcala,
                                                        <br> Concluida la carrera de Tlaxcala Lic. Ingeniera Tecnologías de la Información
                                                ...
                                                <div class="item">
                                                    <div class="main">
                                                        ...
                                                        <p><i class="far fa-calendar-alt"></i>Noviembre 2021 – Actual 2022 | Tlaxcala</p>
                                                    </div>
                                                    <p>Curso de Redes CCNA1, por parte de Universidad de Politécnica del estado de Tlaxcala
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="page pt-contact" data-simplebar>
                                            <section class="container" id="pt-contact">
                                                <!-- Section Title -->
                                                <div class="header-page mt-70 mob-mt">
                                                    <h2>Prueba1</h2>
                                                    <iframe src="https://xus.000webhostapp.com/" frameborder="0" style="height: 200;">
                                                ...
                                                <div class="box contact-info">
                                                    <div class="row">
                                                        <div class="col-lg-4 col-sm-12 info">
                                                            ...
                                                            <p>pop6app@gmail.com</p>
                                                            <span>Email</span>
                                                        </div>
                                                        <div class="col-lg-4 col-sm-12 info">
                                                            <i class="fas fa-map-marker-alt"></i>
                                                            <p>Boulevard Mariano Sanchez</p>
                                                            <span>Addres</span>
                                                        </div>
                                                        <div class="col-lg-4 col-sm-12 info">
...
<!-- Mirrored from baha.malyarchuk.space/index-image.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Aug 2019 01:03:43 GMT -->
